...
const Navbar = () => {
     ...
     const { setFilteredData, products, logout, isAuthenticated, cart,reload } = useContext(AppContext);
               ...
               <div className="nav sticky-top">
                    ...
                    {location.pathname == '/' && (
                         <div className="sub_bar">
                              <div className="items" onClick={() => (setFilteredData(products),setShow(true))}>Home</div>
