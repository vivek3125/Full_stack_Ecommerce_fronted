...
const TableProduct = ({ cart }) => {
     ...
     return (
          <>
               <table class="table table-bordered border-primary bg-dark text-center">
                    <thead>
                         <tr>
                    ...
                    <tbody>
                         {cart?.items?.map((product) => (
                              <tr key={product._id}>
                                   ...
                                   <td className='bg-dark text-light'><span className="material-symbols-outlined" onClick={() => decreaseQty(product.productId, 1)}>
                                        do_not_disturb_on
                                   </span></td>
                                   <td className='bg-dark text-light'><span className="material-symbols-outlined" onClick={() => {
                         ...
                         <tr>
                              ...
                              <td className='bg-dark text-light'><button className='btn btn-primary' style={{ fontWeight: 'bold' }}>{qty}</button></td>
