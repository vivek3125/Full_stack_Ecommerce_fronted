  ...
  return (
    <>
      <div className="container">
        ...
        <h3 className='text-center'>It will delivered in 2 days</h3>
      </div>
        ...
        <table className="table table-bordered border-primary bg-dark">
          <thead className='bg-dark'>
            <tr>
              ...
              <th scope="col" className='bg-dark text-light text-center'>OrderDetails & ShippingAddress</th>
            </tr>
          </thead>
            ...
            <tr>
              ...
              <td className='bg-dark text-light'>
                ...
                <ul style={{fontWeight:'bold'}}>
                  ...
                  <li>NearbBy:{" "}{latestOrder?.userShipping?.address}</li>
                </ul>
